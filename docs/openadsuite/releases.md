...
- Use the tagged image and compose file for integration into [OpenADSim](../openadsim/custom-integration.md).
- Once tested successfully in [OpenADSim](../openadsim/custom-integration.md), consider creating a pull request for integration into [OpenADStack](../openadstack/openadstack.md).
